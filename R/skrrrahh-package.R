...
#' 
#' This package contains one function, skrrrahh(), with one purpose: To make it easy
...
#' 
#' The package just contains one function \code{\link{skrrrahh}}, check it out to 
#' see what it does. For sound on Windows and MacOS \pkg{BRRR} depends on the 
#' \pkg{audio} package. For sound on Linux \pkg{BRRR} depends on that either
...
#' @name BRRR
#' @docType package
#' @author Brooke Watson <brooke.meredith.watson@gmail.com>
